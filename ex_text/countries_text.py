...
[u"""{{Redirect2
        ...
        |non-sovereign dependencies
        |Dependent territory}}',
    {{cite web
        |title=United Nations Member States
        |url=http://www.un.org/en/members/index.shtml
        |publisher=United Nations|author=Press Release ORG/1469
        |accessdate=28 February 2011|date=3 July 2006}}',
    {{refn
        |This column indicates whether or not a state is a member of the [[United Nations]].<ref name="unms"/> It also indicates which non-member states participate in the [[United Nations System]] through membership in the [[International Atomic Energy Agency]] or one of the [[List of specialized agencies of the United Nations|specialized agencies of the United Nations]]. 
        All United Nations members belong to at least one specialized agency and are parties to the statute of the [[International Court of Justice]].|group = "Note"}}'

    {{refn
        |This column indicates whether or not a state is the subject of a major sovereignty dispute. Only states whose entire sovereignty is disputed by another state are listed.|group = "Note"}}
    ...
    {{flag|Algeria}}
    {{extent}}
    {{flag|Andorra}}', u'{{extent}}', u'{{cite news|url=http://news.bbc.co.uk/1/hi/world/europe/country_profiles/992562.stm#leaders |title=Andorra country profile |publisher=BBC News |accessdate=8 November 2011}}
    {{flag|Angola}}', u'{{extent}}'
    {{flag|Antigua and Barbuda}}', u'{{extent}}', u'{{cite web\\n | author = Government of Antigua and Barbuda\\n | title = Chapter 44: The Barbuda Local Government Act\\n | work = Laws of Antigua and Barbuda\\n | url = http://www.laws.gov.ag/acts/chapters/cap-44.pdf\\n | accessdate = 2010-11-10}}'
    {{flag|Argentina}}', u'{{extent}}', u'{{flag|Armenia}}', u'{{cite web|format=PDF|url=http://www.foreignaffairscommittee.org/includes/content_files/Report%2021%20-%20Visit%20to%20Azerbaijan.pdf|title=Pakistan Worldview, Report 21, Visit to Azerbaijan|publisher=Senate of Pakistan Foreign Relations Committee|date=2008|dead-url=y|archive-url=https://web.archive.org/web/20090219074354/http://foreignaffairscommittee.org/includes/content_files/Report%2021%20-%20Visit%20to%20Azerbaijan.pdf|archive-date=19 February 2009}}', u'{{Cite news|url=http://news.az/articles/armenia/86325|title=Pakistan the only country not recognizing Armenia \\u2013 envoy|publisher=News.Az|date=February 5, 2014|accessdate=February 17, 2014|quote=We are the only country not recognizing Armenia as a state.}}'
