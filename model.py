...
class User(db.Model, UserMixin):
    ...
    #Inheriting from UserMixin gives you default versions of is_authenticated(), is_active(), is_anonymous(), and get_id() functions required by Flask-Login
    ...
    def get_id(self):
        """Returns the email address to satisfy the id requirement"""
        return self.email
    ...
    def check_password(self, password):
        ...
        if bcrypt.hashpw(password, bcrypt.gensalt()) == hashed:
            return True
        else:
            return False
